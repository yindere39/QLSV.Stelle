...
public class PaginationTaglib extends SimpleTagSupport {
	...
	private String constructLink(int page, String text, String className, boolean disabled) {
		...
		if(disabled)
			...
			link.append(">").append("<a href=\""+uri+"?offset="+page + "&keyword=" + keyword+ "\">" + text+"</a></li>");
	...
	public String getLopStelle() {
		return lopStelle;
	}

	public void setLopStelle(String lopStelle) {
		this.lopStelle = lopStelle;
	}
